---
title: "STged: Gene expression Deconvolution in Scenario 2 simulated datasets"
output:
...
model.est = STged(sc_exp = sc_exp, sc_label = sc_label, 
                  ...
                  lambda1 = NULL, lambda2 = NULL, cutoff = 0.05, maxiter = 500,  epsilon = 1e-5)
